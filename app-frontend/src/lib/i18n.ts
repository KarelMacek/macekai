...
const translations = {
  en: {
    ...
    noDiagnosticsTitle: "No diagnostics yet",
    noDiagnosticsBody: "This account doesn't have a diagnostics unlocked yet.",
    buyHere: "Buy here",
  ...
  cs: {
    ...
    noDiagnosticsTitle: "Zatím žádná diagnostika",
    noDiagnosticsBody: "Tento účet zatím nemá odemčenou žádnou diagnostiku.",
    buyHere: "Koupit zde",
