...
const translations = {
  en: {
    ...
    adminAiConsentLabel: "OK to use AI/ML for this client?",
    adminAiConsentYes: "Yes",
    adminAiConsentNo: "No",
    adminAiConsentUnknown: "Not recorded yet",
  ...
  cs: {
    ...
    adminAiConsentLabel: "Smí se u tohoto klienta použít AI/ML?",
    adminAiConsentYes: "Ano",
    adminAiConsentNo: "Ne",
    adminAiConsentUnknown: "Zatím nezaznamenáno",
