...
const translations = {
  en: {
    ...
    viewMyAnswers: "View your filled-in questionnaire",
    ...
    adminNotesLabel: "Notes (shown to the customer in the app)",
    adminAiConsentLabel: "OK to use AI on their answers?",
    adminMlConsentLabel: "OK for statistics/ML research?",
    adminConsentYes: "Yes",
    adminConsentNo: "No",
    adminConsentUnknown: "Not recorded yet",
    adminEmailSubjectLabel: "Email subject",
    adminEmailBodyLabel: "Email body",
    adminEmailBodyHint: "Prefilled with a draft — edit freely, signature included. This is sent exactly as written.",
    adminPublishLabel: "Publish to customer",
    adminPublishHint: "The customer will get exactly the email above.",
  ...
  cs: {
    ...
    viewMyAnswers: "Zobrazit vyplněný dotazník",
    ...
    adminNotesLabel: "Poznámky (zobrazí se klientovi v aplikaci)",
    adminAiConsentLabel: "Smí AI zpracovat jeho/její odpovědi?",
    adminMlConsentLabel: "Souhlas se statistikou/ML výzkumem?",
    adminConsentYes: "Ano",
    adminConsentNo: "Ne",
    adminConsentUnknown: "Zatím nezaznamenáno",
    adminEmailSubjectLabel: "Předmět e-mailu",
    adminEmailBodyLabel: "Text e-mailu",
    adminEmailBodyHint: "Předvyplněno konceptem — volně upravte, včetně podpisu. Odešle se přesně tak, jak je napsáno.",
    adminPublishLabel: "Zveřejnit klientovi",
    adminPublishHint: "Klientovi bude odeslán přesně e-mail výše.",
