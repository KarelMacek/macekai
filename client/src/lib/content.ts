...
export const t = {
  ...
  // ── Hero ─────────────────────────────────────────────────────────────────
  hero: {
    label: { cs: "ACC (ICF) certifikovaný kouč · AI & Data", en: "ACC (ICF) Certified Coach · AI & Data" },
    ...
    ctaSecondary: { cs: "Zobrazit ukázku koučování", en: "View a coaching demo" },
  ...
  method: {
    ...
    packages: {
      cs: [
        { label: "2–5 týdnů · 3 sezení", tag: "RYCHLÝ ZÁSAH", price: "10 800 Kč", desc: "Rychlý taktický zásah. Konkrétní problém, konkrétní posun. Ideální pro jasně definovanou výzvu." },
        { label: "3–6 měsíců · 12 sezení", tag: "PLNÝ PROGRAM", price: "43 200 Kč", desc: "Hloubková transformace, systematická práce na sobě. Vynalezni verzi 2.0." },
      ],
      en: [
        { label: "2–5 weeks · 3 sessions", tag: "QUICK SPRINT", price: "450 EUR", desc: "A fast tactical intervention. One concrete problem, one concrete shift. Ideal for a clearly defined challenge." },
        { label: "3–6 months · 12 sessions", tag: "FULL PROGRAM", price: "1 800 EUR", desc: "Deep transformation, systematic work on yourself. Invent your version 2.0." },
      ],
    },
  },
  ...
  whyme: {
    ...
    reasons: {
      cs: [
        ...
        { icon: "rocket", title: "Kreativní systém", desc: "Povedu tvé přemýšlení k nápadu a tvé kroky k realitě, s disciplínou, jakou jsem se naučil jako výzkumník." },
      ],
      en: [
        ...
        { icon: "rocket", title: "Creative system", desc: "I'll guide your thinking toward the idea, and your steps toward reality, with the discipline I learned as a researcher." },
      ],
    },
  },
  ...
  problems: {
    ...
    items: {
      cs: [
        ...
        { icon: "users", label: "Vztahy & work-life", desc: "Jak nebýt sám, když nemáš čas — nejen pro expaty" },
        ...
        { icon: "zap", label: "Efektivita & produktivita", desc: "Jak vyboxovat čas a začít řídit svůj den" },
        ...
        { icon: "bridge", label: "Akademie & byznys", desc: "Propojení výzkumu s reálným podnikáním" },
      ],
      en: [
        ...
        { icon: "users", label: "Relationships & work-life", desc: "How not to be alone when you have no time — not just for expats" },
        ...
        { icon: "zap", label: "Efficiency & productivity", desc: "How to carve out time and start owning your day" },
        ...
        { icon: "bridge", label: "Academia & business", desc: "Connecting research with real business" },
      ],
    },
  },
  ...
  testimonials: {
    ...
    cases: {
      cs: [
        { quote: "Ty rozhovory smysluplně přispěly ke směru, kterým jsem se od té doby vydala, a k větší jistotě v mých dnešních rozhodnutích.", name: "Anna Potanina", role: "Developer, Barclays Investment Bank" },
        { quote: "Ujasnilo mi to, co chci dělat, a přineslo to spoustu překvapivých aha momentů. Topil jsem se v úvahách o mnoha možnostech — kterou zvolit a kterou ne? Karel mi pomohl pochopit, co opustit a čemu se věnovat.", name: "Jiří Horáček", role: "Concept Artist, GRIP Studios" },
      ],
      en: [
        { quote: "Those conversations contributed meaningfully to the direction I have taken since, and to a greater sense of confidence in my decisions today.", name: "Anna Potanina", role: "Developer, Barclays Investment Bank" },
        { quote: "It clarified what I want to do, with many surprising aha moments. I was drowning in thoughts of many possibilities — which one to take and which not? Karel helped me realise what to leave and what to pursue.", name: "Jiří Horáček", role: "Concept Artist, GRIP Studios" },
      ],
    },
  },
  ...
  demo: {
    ...
    transcript: { cs: "UKÁZKA — SEZENÍ 01 — SINGAPUR", en: "DEMO — SESSION 01 — SINGAPORE" },
    showMore: { cs: "Zobrazit více →", en: "Show more →" },
    chat: {
      cs: [
        { role: "client", name: "Ravi", text: "Jak mi ta tvoje neurověda pomůže při těch nočních kódovacích maratonech, když jsem úplně hotový? Nebo se šéfem, co vůbec nerozumí inovacím? A kolik to stojí času, když pracuju 60 hodin týdně?" },
        { role: "coach", name: "Karel", text: "Děkuju za tyhle asi čtyři otázky v jednom. 60 hodin, šéf nerozumí inovacím, noční maratony — já to slyším. Než ti řeknu víc, řekni mi: jak dlouho tohle všechno vlastně už řešíš?" },
        { role: "client", name: "Ravi", text: "Je to od té doby, co jsem se přestěhoval do Singapuru. Takže tři roky." },
        { role: "coach", name: "Karel", text: "Tři roky. To není únava z minulého týdne — to je hlubší téma. Ravi, jestli se můžu ještě zeptat, kdyby sis to vyčerpání představil jako scénu z filmu, jak by vypadala?" },
        { role: "client", name: "Ravi", text: "Jako přehřátý procesor v serverovně uprostřed noci. Všechny větráky jedou na maximum, ale už to nezabírá a systém se co chvíli zhroutí." },
        { role: "coach", name: "Karel", text: "Přehřátí a co chvíli se to zhroutí... To je panečku představa. A když se ta filmová scéna posune najednou k lepšímu — co se tam stane?" },
        { role: "client", name: "Ravi", text: "Hm... no, nějak se tam pořádně ochladí... třeba se tam dostane polární vítr... do serverovny." },
        ...
        { role: "coach", name: "Karel", text: "Co kdybys ji měl pořád před očima?" },
        { role: "client", name: "Ravi", text: "To by bylo fajn." },
        { role: "coach", name: "Karel", text: "A jak ji mít pořád před očima?" },
        { role: "client", name: "Ravi", text: "No vygeneruju si obrázek a dám si to na plochu." },
        { role: "coach", name: "Karel", text: "Ravi, to zní jako plán. Rád se vrátím k původní otázce, ale... můžu ještě k těm tvým 60 hodinám?" },
        { role: "client", name: "Ravi", text: "Okay." },
        { role: "coach", name: "Karel", text: "Ravi, kdyby to bylo o 2 míň... 58... jak by ses reálně cítil?" },
        { role: "client", name: "Ravi", text: "No bylo by to fajn, ale pořád to neřeší nic." },
        { role: "coach", name: "Karel", text: "Zatím to nic neřeší.... Ravi, kdybys je prostě musel vyboxovat, třeba kvůli nějaké léčbě, prostě jen 2 hodiny, jak bys to zařídil?" },
        { role: "client", name: "Ravi", text: "Asi bych si vyblokoval jeden večer, kdy prostě fakt nepracuju." },
        { role: "coach", name: "Karel", text: "A který den v týdnu by to mohlo klapnout?" },
        { role: "client", name: "Ravi", text: "Co já vím, třeba neděle." },
        { role: "coach", name: "Karel", text: "Ravi, takže si můžeš vygenerovat obrázek se sněhem v serverovně a zařídit, abys měl nedělní večer pro sebe." },
        ...
        { role: "coach", name: "Karel", text: "Ravi, díky, že jsme to mohli probrat. Když se vrátím k tvé první otázce a řeknu \"co Ravi vlastně v životě chce\" nebo \"jak vypadá Ravi 2.0\" — jak moc bys s tím chtěl pohnout právě teď?" },
      ],
      en: [
        { role: "client", name: "Ravi", text: "How is your neuroscience going to help me during those late-night coding marathons when I'm completely done? Or with a boss who doesn't get my innovations at all? And how much time does this even take when I'm already working 60 hours a week?" },
        { role: "coach", name: "Karel", text: "Thanks for those four questions packed into one. 60 hours, a boss who doesn't get your innovations, late-night marathons — I hear you. Before I say more, tell me: how long have you actually been dealing with all this?" },
        { role: "client", name: "Ravi", text: "Since I moved to Singapore. So, three years." },
        { role: "coach", name: "Karel", text: "Three years. That's not last week's fatigue — that's a deeper issue. Ravi, if I can ask — if you had to picture that exhaustion as a scene from a film, what would it look like?" },
        { role: "client", name: "Ravi", text: "Like an overheated processor in a server room in the middle of the night. All the fans are running at full speed, but it's not helping anymore, and the system keeps crashing." },
        { role: "coach", name: "Karel", text: "Overheating, and it keeps crashing... That's quite an image. And if that film scene suddenly shifts for the better — what happens there?" },
        { role: "client", name: "Ravi", text: "Hm... well, it somehow really cools down... maybe a polar wind gets in... into the server room." },
        { role: "coach", name: "Karel", text: "A polar wind in the server room..." },
        ...
        { role: "coach", name: "Karel", text: "What if you had it in front of you all the time?" },
        { role: "client", name: "Ravi", text: "That would be nice." },
        { role: "coach", name: "Karel", text: "And how do you keep it in front of you all the time?" },
        { role: "client", name: "Ravi", text: "Well, I'll generate an image and set it as my wallpaper." },
        { role: "coach", name: "Karel", text: "Ravi, that sounds like a plan. I'd like to come back to your original question, but... can I ask about those 60 hours of yours?" },
        { role: "client", name: "Ravi", text: "Okay." },
        { role: "coach", name: "Karel", text: "Ravi, if it were 2 hours less... 58... how would you actually feel?" },
        { role: "client", name: "Ravi", text: "It'd be nice, but it still doesn't solve anything." },
        { role: "coach", name: "Karel", text: "It doesn't solve anything yet.... Ravi, if you simply had to carve out those 2 hours — say, for some kind of treatment — how would you make it happen?" },
        { role: "client", name: "Ravi", text: "I'd probably block off one evening where I just really don't work." },
        { role: "coach", name: "Karel", text: "And which day of the week could that work?" },
        { role: "client", name: "Ravi", text: "I don't know, maybe Sunday." },
        { role: "coach", name: "Karel", text: "Ravi, so you can generate that image of snow in the server room, and make sure you have Sunday evening to yourself." },
        ...
        { role: "coach", name: "Karel", text: "How much do you want to do it?" },
        { role: "client", name: "Ravi", text: "Yeah, I actually want to do it." },
        { role: "coach", name: "Karel", text: "So you'll do it?" },
        { role: "client", name: "Ravi", text: "Yeah, I will." },
        { role: "coach", name: "Karel", text: "Ravi, thanks for letting us talk through this. If I go back to your first question and ask \"what does Ravi actually want in life\" or \"what does Ravi 2.0 look like\" — how much would you like to move on that right now?" },
      ],
    },
  },
  ...
  contact: {
    ...
    emailCopied: { cs: "E-mailová adresa karel@macek.ai zkopírována do schránky", en: "Email address karel@macek.ai copied to clipboard" },
    linkedin: { cs: "nebo se spojme na LinkedIn", en: "or connect on LinkedIn" },
